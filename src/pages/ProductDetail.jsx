        ...
        >
          ...
          <div>
            <div className="mb-6">
              ...
              {/* Replacement & COD Badges */}
              <div className="flex flex-wrap gap-3 mb-4">
                {(product.replacementDays ?? 7) > 0 && (
                  <div className="flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2">
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                    <span className="text-blue-700 font-medium text-sm">
                      {product.replacementDays ?? 7} Days Replacement
                    </span>
                  </div>
                )}
                {(product.cashOnDelivery ?? true) ? (
                  <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-3 py-2">
                    ...
                    <span className="text-green-700 font-medium text-sm">Cash on Delivery</span>
                  </div>
                ) : (
                  <div className="flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-lg px-3 py-2">
                    ...
                    <span className="text-orange-700 font-medium text-sm">Prepaid Only</span>
                  </div>
                )}
              </div>
            </div>
